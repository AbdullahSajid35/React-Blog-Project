  ...
  const handleChange=(panel,isExpanded)=>{
    ...
    return (
      <div className='text-left'>
        ...
        <p className='text-center text-[18px]  text-gray-500 pt-4'>Build something awesome for your business, your portfolio or yourself.</p>
        <div className='mx-36 my-20  text-[20px]'>
